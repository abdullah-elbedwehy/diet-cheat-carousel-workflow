...
3. **Set consistency**: use the fixed geometry from `render-spec.md` byte-for-byte. Identity-specific assets and colors come from `identity-guide.md`; neither file may redefine the other's values.
